...
mpirun ${NQSII_MPIOPTS} -x PATH -np 8 --map-by ppr:1:node --bind-to none --report-bindings \
 /home/NBB/yu_mingzhe/miniconda3/envs/basic_env/bin/python /work/NBB/yu_mingzhe/kfac-pytorch/multi_node_mobilev3_minist_ddp.py \
