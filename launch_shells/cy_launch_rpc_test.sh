...
mpirun ${NQSII_MPIOPTS} -x PATH -np 4 --map-by ppr:1:node:PE=24 --report-bindings \
 /home/NBB/yu_mingzhe/miniconda3/envs/basic_env/bin/python /work/NBB/yu_mingzhe/kfac-pytorch/rpc_test_multinode.py \
